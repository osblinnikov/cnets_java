...
import com.github.osblinnikov.cnetsjava.runnablescontainer.*;
import com.github.osblinnikov.cnetsjava.readerwriter.*;
import com.github.osblinnikov.cnetsjava.mapbuffer.*;
...
class intBoxerWriter implements RunnableStoppable{
  ...
  public RunnablesContainer getRunnables(){
    ...
    runnables.setCore(this, "intBoxerWriter",1);
    return runnables;
  }
  ...
  public void run(){
    ...
    if (d != null) {
      ...
      System.out.println("not write "+(packIterator - lastSecPack));
    }
  }
...
class intBoxerReader implements RunnableStoppable{
  ...
  public RunnablesContainer getRunnables(){
    ...
    RunnablesContainer runnables = new RunnablesContainer();
    runnables.setCore(this,"intBoxerReader",1);
    return runnables;
  }
...
//      System.out.println("not read "+(packIterator - lastSecPack));
    }
  }
...
public class selectorTest {
  ...
  public void testSelector(){
    ...
    Selector rSelector = new Selector(new Reader[]{r0});
    intBoxerReader readerKernel = new intBoxerReader(rSelector.getReader(0));
